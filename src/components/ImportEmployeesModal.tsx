    ...
    >
      ...
      >
        ...
        <div className="max-h-[70vh] overflow-y-auto px-6 py-5">
          ...
          {refs && (
            <>
              {/* Step 1: download template (Talenta-style card) */}
              <section className="mb-6">
                <h3 className="text-base font-semibold" style={{ color: 'var(--color-text)' }}>
                  {t.importDownloadSectionTitle}
                </h3>
                <p className="mt-0.5 text-sm" style={{ color: 'var(--color-text-secondary)' }}>
                  {t.importDownloadSectionSubtitle}
                </p>
                ...
                <button
                  ...
                  disabled={busy}
                  className="mt-3 flex w-full items-center gap-3 rounded-xl border px-4 py-3 text-left transition-colors disabled:opacity-60"
                  style={{
                ...
                >
                  ...
                  <span
                    ...
                    style={{ backgroundColor: 'color-mix(in srgb, #16a34a 14%, transparent)' }}
                  >
                  ...
                  <span className="min-w-0 flex-1 truncate text-sm font-medium" style={{ color: 'var(--color-text)' }}>
                    {downloading ? t.importDownloadingTemplate : t.importTemplateFilename}
                  </span>
              ...
              <section className="mb-6">
                ...
                <ul className="mt-2 space-y-1.5 pl-5 text-sm" style={{ color: 'var(--color-text-secondary)', listStyle: 'disc' }}>
                  <li>{t.importTip1}</li>
                  <li>{t.importTip2}</li>
                  <li>{t.importTip3}</li>
                  <li>{t.importTip4}</li>
              ...
              <section className="mb-5">
                ...
                <div className="mt-2 flex items-center gap-3 rounded-lg border px-3 py-2"
                ...
                >
                  ...
                  <button
                    ...
                    style={{ borderColor: 'var(--color-border)', color: 'var(--color-text)', backgroundColor: 'var(--color-bg-tertiary)' }}
                  >
                    {t.importChooseFile}
                  </button>
                  <span className="min-w-0 flex-1 truncate text-xs" style={{ color: selectedFileName ? 'var(--color-text)' : 'var(--color-text-tertiary)' }}>
